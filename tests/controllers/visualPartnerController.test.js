const visualPartnerController = require("../../lib/controllers/visualPartnerConstroller");


describe("testing for visualPartnerController",()=>{
    test("test for getStudents()",()=>{
        expect(visualPartnerController.getStudents()).toEqual([
            {
    ...
    test("test for have certification",()=>{

        expect(visualPartnerController.haveCertification()).toEqual([
            {
              id: '6264d5d89f1df827eb84bb23',
              name: 'Warren',
              email: 'Todd@visualpartnership.xyz',
    ...
    test("test for credits()",()=>{

        expect(visualPartnerController.credits()).toEqual([
            {
              id: '6264d5d89f1df827eb84bb23',
              name: 'Warren',
              email: 'Todd@visualpartnership.xyz',
